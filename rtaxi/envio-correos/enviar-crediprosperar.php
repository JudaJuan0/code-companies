...
try {
    ...
    // $mail->addAddress('acortesrta@gmail.com');     //Add a recipient
    ...
    $mail->AddEmbeddedImage("../images/logo-credi-prosperar.png", "url-logo");
    $mail->Body    = '<div style="background-color: #e9eaeb; text-align: center; width: 100%;">'.
                    '   <img src="cid:url-logo" alt="logo-rtaxi" style="width: 350px;padding: 40px;">'.
                 '   </div>'.
